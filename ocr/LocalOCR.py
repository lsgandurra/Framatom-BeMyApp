...
if __name__ == '__main__':
    ...
    print("1. TEXT file \"%s\" not found - Process PDF file \"%s\"" %
          (args.text_output, args.pdf_filename))
    print(args.pdf_resolution)
    output = p.process(args.pdf_filename, 300,
                       args.ocr_imageformat, args.ocr_do_orientation)
