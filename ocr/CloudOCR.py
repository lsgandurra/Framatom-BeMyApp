...
class CloudOCR(object):
    ...
    def pdfimages(self):
        ...
        comando = "pdfimages -png %s %s/%s" % (
            self.pdf_input, self.img_dir, self.img_prefix)
        cmd_start = time.time()
...
if __name__ == '__main__':
    ...
    b = CloudOCR(args.ocr_language, args.pdf_filename,
                 args.img_dir, args.ocr_imageformat, args.img_prefix)
    b.pdfimages()
    # b.convert()
    b.list()
    text = b.visionapi()
